...
class MockCnnUtils: public CnnUtils {
    public:
        ...
        MOCK_METHOD(void, loadWeights, (bool loadNew), (override));
        MOCK_METHOD(void, loadKernels, (bool loadNew), (override));
...
TEST(CnnUtilsTest,leakyReluWorks){   
...
TEST(CnnUtilsTest,floatCmpWorks){   
...
TEST(CnnUtilsTest,sigmoidWorks){   
...
TEST(CnnUtilsTest,softmaxWorks){   
...
TEST(CnnUtilsTest,dotProduct8fWorks){

}

TEST(CnnUtilsTest,horizontalSumWorks){

}

TEST(CnnUtilsTest,floorModWorks){   
...
TEST(CnnUtilsTest,fixedSizedConvolutionWorks){

}

TEST(CnnUtilsTest,prePaddedConvolutionWorks){

}

TEST(CnnUtilsTest,variableSizedConvolutionWorks){

}

TEST(CnnUtilsTest,maxPoolWorks){

}

TEST(CnnUtilsTest,gaussianBlurKernelWorks){

}

TEST(CnnUtilsTest,normaliseImgWorks){
